...
namespace CodePlex.SharePointInstaller
{
  partial class Installer
  {
    ...
    private void InitializeComponent()
    {
        ...
        this.buttonPanel.Controls.Add(this.previousButton, 1, 0);
        ...
        // previousButton
        // 
        this.previousButton.AccessibleDescription = null;
        this.previousButton.AccessibleName = null;
        resources.ApplyResources(this.previousButton, "previousButton");
        this.previousButton.BackgroundImage = null;
        this.previousButton.Font = null;
