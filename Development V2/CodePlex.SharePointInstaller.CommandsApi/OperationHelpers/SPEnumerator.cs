...
namespace CodePlex.SharePointInstaller.CommandsApi.OperationHelpers
{
    public class SPEnumerator
    {
        ...
        public class SPWebApplicationEventArgs : EventArgs
        {
            ...
            public SPWebApplicationEventArgs(SPWebApplication webApp)
            {
                m_WebApp = webApp;
            }
        ...
        public class SPSiteEventArgs : SPWebApplicationEventArgs
        {
            ...
            public SPSiteEventArgs(SPSite site) : base(site.WebApplication)
            {
                m_Site = site;
            }
            public SPSite Site
        ...
        public class SPWebEventArgs : SPSiteEventArgs
        {
            ...
            public SPWebEventArgs(SPSite site, SPWeb web) : base(site)
            {
                m_Web = web;
            }
            public SPWeb Web
        ...
        public class SPListEventArgs : SPWebEventArgs
        {
            ...
            public SPListEventArgs(SPSite site, SPWeb web, SPList list) : base(site, web)
            {
                m_List = list;
            }
            public SPList List
        ...
        public class PublishingPageEventArgs : SPListEventArgs
        {
            ...
            public PublishingPageEventArgs(SPSite site, SPWeb web, PublishingPage page) : base(site, web, page.ListItem.ParentList)
            {
                m_Page = page;
            }
...
#else
            public PublishingPageEventArgs(SPSite site, SPWeb web, SPList list) : base(site, web, list)
            {}
#endif
        }
